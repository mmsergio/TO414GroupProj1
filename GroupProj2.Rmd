...
- Which profile are we retaining and who is leaving the subscription? (Comparison among clusters and profiles) 
  During our cluster analysis, we found that two clusters seem more worth targeting than the other client profiles out of the 5 clusters we observed. The cluster with the highest churn rate seems to have customers who are single, and with no kids, and requires a lot of assistance with their telecommunication services. On the other hand, the profiles who don't renew their subscription and have low churn rates are those have a  partner and kids, that don't get a lot of the services offered.
