...
Questions for the first part:
  - How can we improve the retention rate? (Predict, then engage those clients that we have identified that will remain, in retention promotions)
...
## Maybe add some financials to make the case first question more interesting
  ...
  Variable costs of engaging a client in consumer retention promotions
...
We just need to change this variables

|               | Logistic Reg   | KNN      | Neural Net  |    SVM     |   Decision Tree | Stacked Model |Stacked Model with Cost |
|:--------------|:--------------:|:--------:|:-----------:|:----------:|:---------------:|:-------------:|:----------------------:|
|   Kappa       |  0.29          |0.2       | 0.29        |     0.26   |    0.36         | 0.33          | 0.44                   |
|  Sensitivity  |  0.22          |  0.13    |   0.23      | 0.2        | 0.33            | 0.27          | 0.6                    |
