...
```{r}
#Tree cluster 4
allpredictions4 <- data.frame(log4prediction, KNNprediction4, ANNprediction4, SVMprediction4, treepred4, clients4_testlabels)
...
# tree cluster 3
allpredictions3 <- data.frame(log3prediction, KNNprediction3, ANNprediction3, SVMprediction3, treepred3, clients3_testlabels)
