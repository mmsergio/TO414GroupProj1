...
tele_norm_cl1_train$yyes <- NULL
  #We remove the yyes column from the train test

tele_norm_cl1_trainlabels <- tele_norm_cl1[-test_cl1, "yyes"]
  #Create labels for the true results (basically yyes variable)
...
tele_norm_cl1_test$yyes2 <- tele_norm_cl1_knnprediction
  #We add the preduction to the test as a new  variable
